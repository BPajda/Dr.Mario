...
var gameboard = {
    ...
    pillCheck: function (balls) {

        var isAllAnFall = [...balls].every((e) => this.komorkaCheck(e) == true)
        if (isAllAnFall) {
            return true
        } else {
            return false
    ...
    scoreUpload: function () {
        ...
        if (localStorage.getItem("highscore") == null) {
            hscore.style.backgroundImage = "url('img/cyfry/0.png')"
        } else {
...
document.body.onkeydown = nasluchiwacz
function spadanie() {
    document.body.onkeydown = "unlucky"
